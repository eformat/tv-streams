CREATE SOURCE avgr1
--FROM KAFKA BROKER 'tv-cluster-kafka-bootstrap:9092' TOPIC 'submissions-aggregated-1'
...
CREATE SOURCE avgr5
--FROM KAFKA BROKER 'tv-cluster-kafka-bootstrap:9092' TOPIC 'submissions-aggregated-5'
